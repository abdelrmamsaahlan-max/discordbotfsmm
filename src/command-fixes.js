...
const commands=[
 new SlashCommandBuilder().setName('exist').setDescription('Check Brainrot existence data.').addStringOption(o=>o.setName('brainrot').setDescription('Type the Brainrot name').setRequired(true).setAutocomplete(false)),
