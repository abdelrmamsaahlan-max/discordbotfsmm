...
// Shared Middleman order/ticket branding.
...
EmbedBuilder.prototype.setTitle=function(title){
  if(title==='🤝 FSMM MIDDLEMAN'){
    this.__fsmmMiddlemanOrder=true;
...
EmbedBuilder.prototype.setDescription=function(description){
  if(this.__fsmmMiddlemanOrder||this.__fsmmMiddlemanTicket)return originalSetDescription.call(this,MIDDLEMAN_DESCRIPTION);
...
EmbedBuilder.prototype.setFooter=function(data){
  if(this.__fsmmMiddlemanOrder||this.__fsmmMiddlemanTicket)return originalSetFooter.call(this,{text:'POWERED BY FSMM'});
